...
void trap_handler(unsigned long mcause, unsigned long mtval)
{
	...
	switch(mcause)
	{
		...
		case CAUSE_FETCH_PAGE_FAULT: break;
		case CAUSE_LOAD_PAGE_FAULT: break;
		case CAUSE_STORE_PAGE_FAULT: break;
		case CAUSE_FETCH_GUEST_PAGE_FAULT: break;
		case CAUSE_LOAD_GUEST_PAGE_FAULT: break;
		case CAUSE_STORE_GUEST_PAGE_FAULT: break;
	}
