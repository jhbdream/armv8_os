...
#define pud_offset_phys(dir, addr)                                             \
	(__pgd_to_phys((*dir)) + pud_index(addr) * sizeof(pud_t))
#define pmd_offset_phys(dir, addr)                                             \
	(__pud_to_phys((*dir)) + pmd_index(addr) * sizeof(pmd_t))
#define pte_offset_phys(dir, addr)                                             \
	(__pmd_to_phys((*dir)) + pte_index(addr) * sizeof(pte_t))

#define pud_set_fixmap(dir, addr)                                              \
	((pud_t *)set_fixmap_offset(FIX_PUD, pud_offset_phys(dir, addr)))
#define pmd_set_fixmap(dir, addr)                                              \
	((pmd_t *)set_fixmap_offset(FIX_PMD, pmd_offset_phys(dir, addr)))
#define pte_set_fixmap(dir, addr)                                              \
	((pte_t *)set_fixmap_offset(FIX_PTE, pte_offset_phys(dir, addr)))
