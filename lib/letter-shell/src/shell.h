...
#define SHELL_AGENCY_FUNC(_func, ...) \
    void SHELL_AGENCY_FUNC_NAME(_func)(int p1, int p2, int p3, int p4, int p5, int p6, \
                                       int p7) \
    { \
        _func(__VA_ARGS__); \
    }
...
#    define SHELL_EXPORT_USER(_attr, _name, _password, _desc) \
        ...
        "shellCommand") = { .attr.value         = _attr | SHELL_CMD_TYPE(SHELL_TYPE_USER), \
...
#    define SHELL_EXPORT_KEY(_attr, _value, _func, _desc) \
        ...
        "shellCommand") = { .attr.value        = _attr | SHELL_CMD_TYPE(SHELL_TYPE_KEY), \
...
#    define SHELL_KEY_ITEM(_attr, _value, _func, _desc) \
        { \
            ...
            .data.key.value = _value, .data.key.function = (void (*)(Shell *))_func, \
            .data.key.desc = #_desc \
        }
