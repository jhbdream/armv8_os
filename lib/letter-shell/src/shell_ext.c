...
extern ShellCommand *shellSeekCommand(Shell *shell, const char *cmd, ShellCommand *base,
...
{
    ShellCommand *command = shellSeekCommand(shell, var + 1, shell->commandList.base, 0);
    if (command) {
...
int shellExtRun(Shell *shell, ShellCommand *command, int argc, char *argv[])
{
    ...
    case 4:
        return command->data.cmd.function(params[0], params[1], params[2], params[3]);
        // break;
